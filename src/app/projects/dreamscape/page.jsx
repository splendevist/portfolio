    ...
    <div className={calistoga.className}>
      <div className="flex flex-col items-center">
        ...
        <div className="h-64 w-full flex items-center justify-evenly mb-16">
          <p className=" text-6xl font-medium">Calistoga</p>
          <div className="flex">
        ...
        <h2 className="w-1/2 mb-16 text-center text-3xl font-medium">
          ...
          it&apos;s a whimsical fantasy or a chilling nightmare, DreamShare is
          the perfect place to document, share, and explore the mysterious world
          of dreams.
        </h2>
        <Image
          className="mb-16"
