  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <h2 className="w-1/2 mb-16 text-center text-2xl font-medium">
        The ultimate social media app for Stardew Valley enthusiasts! With
        ...
        detailing what you&apos;ve been up to in the game, and choose the season
        to perfectly capture the atmosphere of your virtual farm.
      </h2>
      <div className="h-64 w-full flex items-center justify-evenly mb-16">
        <p className={`${vt323.className} text-6xl font-medium`}>VT323</p>
        <div className="flex">
      ...
      <h2 className="w-1/2 mb-16 text-center text-2xl font-medium">
        Whether you&apos;re sharing the joys of a bountiful harvest in summer or
        the cozy charm of winter, Stardew Social is the perfect place to connect
        with other players and celebrate the idyllic world of Stardew Valley.
      </h2>
      <Image
        className="mb-16"
