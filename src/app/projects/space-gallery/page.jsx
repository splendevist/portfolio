    ...
    <div className={zenDots.className}>
      <div className="flex flex-col items-center">
        ...
        <h2 className="w-1/2 mb-16 text-center text-3xl font-medium">
          ...
          brings the beauty of space right to your fingertips. With Space
          Gallery, you can easily click through stunning images of space and see
          a fun fact about the image, and transform your screen into a cosmic
          masterpiece.
        </h2>
        <div className="h-64 w-full flex items-center justify-evenly mb-16">
          <p className=" text-6xl font-medium">Zen Dots</p>
          <div className="flex">
        ...
        <h2 className="w-1/2 mb-16 text-center text-3xl font-medium">
          ...
          screen. Space Gallery combines the majesty of the cosmos with the
          charm of our feline friends, making it a unique and delightful
          experience for space enthusiasts and cat lovers alike.
        </h2>
        <Image
